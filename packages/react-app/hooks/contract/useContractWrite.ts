...
import MarketplaceInstance from "../../../hardhat/deployments/alfajores/SneakerMarketplace.json";
// Import BigNumber from ethers to handle big numbers used in Celo
import { BigNumber } from "ethers";

// write to a smart contract
export const useContractSend = (functionName: string, args: Array<any>, address?: `0x${string}`) => {
